...
class UserAclCommandsController extends BaseController
{
    public function createAction(ServerRequestInterface $request): ResponseInterface
    {
        ...
        $user = $this->container->get('context.users.query.service')->getOneById($params->id_user);
    ...
    public function updateAction(ServerRequestInterface $request, array $urlParams): ResponseInterface
    {
        ...
        $acl    = $this->container->get('context.acl.query.service')->getOneById($params->id);
        $user   = $this->container->get('context.users.query.service')->getOneById($acl->userId());
